...
export default function Login_home_user() {


    
    // صفحه ثبت نام کاربران خانگی 
            ...
            {page && 
                ...
                <div className="container flex-col">
                    ...
                    <form className="form-info pb-10 container flex-col w-[75%] mt-10 gap-1">
                        ...
                        <label className="pointer-input">نوع کسب و کار خود را وارد کنید :</label>
                        <div className="flex items-center">
                            <input onChange={(e) => setworktype(e.target.value)} className="login-icon-input" type="text" list="languages" placeholder=" نوع کسب و کار خود را وارد کنید . " />
                            <datalist id="languages">
                                <option value="کسب و کارهای آنلاین"></option>
                                <option value="کارآفرینی خانگی"></option>
                                <option value="راه‌اندازی کارگاه‌های تولیدی"></option>
                                <option value="صنایع دستی"></option>
                                <option value="نقاشی روی سفال"></option>
                            </datalist>
                        ...
                        <button onClick={() => setPage(false)} className="btn-f my-3 px-14 py-3 rounded-xl text-white bg-[#9bb0ff]">ثبت نشانی</button>

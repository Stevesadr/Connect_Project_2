        ...
        <main dir="rtl" className="container flex-col mx-auto">
            ...
            <div className="container flex-col">
                ...
                <form className="form-info pb-10 container flex-col w-[75%] mt-10 gap-1">
                    ...
                    <label className="pointer-input">نوع مهارت خود را وارد کنید: </label>
                    <div className="flex items-center mt-2">
                        <input onChange={(e) => setworktype(e.target.value)} className="login-icon-input" type="text" list="languages" placeholder="  نوع مهارت خود را وارد کنید. " />
                        <datalist id="languages">
                            <option value="برنامه نویسی"></option>
                            <option value="گرافیک و دیزاین"></option>
                            <option value="دیجیتال مارکتینگ"></option>
                        </datalist>
                    ...
                    <h2 className="text-[17px] font-bold ml-auto mt-5">در صورت داشتن گواهی آموزشی آن را بارگذاری کنید</h2>
